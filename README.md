...
<div style="background: linear-gradient(135deg, rgba(38,166,154,0.1) 0%, rgba(0,0,0,0.6) 100%); border: 1px solid rgba(38,166,154,0.3); border-radius: 16px; padding: 25px; width: 85%; backdrop-filter: blur(20px); box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37);">
  <h2 style="color: #FFFFFF; font-family: 'Fira Code', monospace; margin-top: 0; letter-spacing: 2px;">⚡ CORE REPOSITORY AXIS</h2>
  <p style="color: #8A9A9A; font-family: 'Fira Code', monospace; font-size: 14px;">
...
<h3 style="color: #FFFFFF; font-family: 'Fira Code', monospace; letter-spacing: 3px;">// TECHNOLOGICAL ECOSYSTEM</h3>
<div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; display: inline-block;">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,js,nodejs,ts,html,css,php,nextjs,react,linux,git,nginx&theme=dark" />
  </a>
</div>
...
<h3 style="color: #FFFFFF; font-family: 'Fira Code', monospace; letter-spacing: 3px;">// PERFORMANCE METRICS</h3>
