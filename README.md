...
<a href="https://t.me/freshfork" target="_blank" style="text-decoration: none;">
  <div style="display: inline-flex; align-items: center; background: #0088cc; color: white; padding: 10px 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600; border-radius: 12px; gap: 8px; box-shadow: 0 4px 12px rgba(0,136,204,0.3);">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 8.82L14.91 16.98C14.78 17.56 14.44 17.7 13.96 17.43L11.32 15.48L10.05 16.71C9.91 16.85 9.79 16.97 9.52 16.97L9.71 14.28L14.6 9.87C14.81 9.68 14.56 9.57 14.28 9.76L8.24 13.56L5.63 12.74C5.06 12.56 5.05 12.17 5.75 11.9L15.93 7.97C16.4 7.8 16.81 8.08 16.64 8.82Z" fill="white"/>
    </svg>
    Связь со мной
  </div>
</a>
